...
INSERT INTO walkLog
VALUES (29,    -- 산책일지번호 walkLogNo
        99,     -- 회원번호 userNo
        111,    -- 동네번호 locationNo
        11111, -- 모임번호 meetingNo
        SYSDATE, -- 작성시간 regDate
        '2023/10/01', -- 시작시간 startTime
        SYSDATE, -- 종료시간 endTime
        SYSDATE, -- 소요시간 logTime
        15, -- 거리 distance
        '내용을 적어주세요', -- 내용 content
...
-- 좌표
INSERT INTO coords
VALUES (13,    -- 좌표번호 coordNo
        20,     -- 좌표순서 coordOrder
        111,    -- 사용처타입 type
        11111, -- 사용처번호 useNo
        '2023/11/01 12:30:00', -- y lat
        '2023/11/01 12:10:00' -- x lng
        ); 
...
NSERT INTO CLUB(clubNo,name,description,regDate,status,join,authNoti,authBoard,authJoin,authSece,locationNo)
